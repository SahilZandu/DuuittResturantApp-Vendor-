                            ...
                            return (
                                <>
                                    <View style={styles.foodItemView}>
                                        ...
                                        <Text numberOfLines={1} style={styles.foodName}>{'data?.name'}</Text>
                                        <Text style={styles.foodPrice}>{currencyFormat(data?.food_item_price)}</Text>
                            ...
                            return (
                                <>
                                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: '4%' }}>
                                        <Text style={{ flex: 1, fontSize: i == 3 ? RFValue(16) : RFValue(13), fontFamily: fonts.medium, color: colors.color8F }}>{data?.name}</Text>
                                        <Text style={{ fontSize: RFValue(16), fontFamily: fonts.medium, color: colors.black }}>{currencyFormat(data?.amount)}</Text>
                                    </View>
                                    {i == 2 && <Line mainStyle={{ marginTop: hp('2%') }} />}
                                </>
                            )
                        })}
                    </View>
