...
const ProductInput = ({
  ...
  // console.log("touched[name]",touched[name],errors[name],name,focusValue)
          ...
          <View
            ...
            <Text
              style={[
                styles.textTouch,
                {
                  color: values[name]?.length > 0 ? colors.color33 : colors.color8F,
          ...
          {prefix && (
            <Text
              style={{
                ...
                left: 10,
                fontSize: RFValue(13),
                color: prefixColor ? prefixColor :colors.green,
              }}>
              {prefix}
            </Text>
          )}
