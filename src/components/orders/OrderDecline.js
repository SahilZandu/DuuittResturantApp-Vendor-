...
const OrderDecline = ({visible, setDecline, onClose}) => {
  const availability = [
    'The restaurant is at full capacity',
    'The restaurant has closed its kitchen',
    'The item(s) you are ordering are no longer available',
    'Other',
  ];
      ...
      <InputScrollView
        ...
        <Pressable
          ...
          <Pressable
            ...
            <Text style={styles.title}>Why you decline this order?</Text>
